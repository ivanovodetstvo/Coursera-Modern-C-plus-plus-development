...
##### Пояснение #####
В этой задаче вам надо прислать на проверку файл с реализацией функции _FindMaxRepetitionCount_, а также дополнительных функций, если это необходим. **Этот файл не должен содержать функцию main и типы Lang и Region**. В противном случае вы получите ошибку компиляции.